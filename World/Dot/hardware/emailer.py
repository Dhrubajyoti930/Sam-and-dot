"""
emailer.py â€” Standalone Email Utility
Project Sam-and-dot
...
def send_html_email(
    ...
    try:
        ...
        print(f"[emailer] Sent â†’ {to_address}: '{subject}'")
        return True
    except smtplib.SMTPAuthenticationError:
        print("[emailer] AUTH FAILED â€” check EMAIL and APP_PSWD.")
        return False
          ...
          <tr>
            <td style="padding:36px 36px 24px 36px;color:#2c2c2c;font-size:15px;line-height:1.7;">
              ...
              <p style="margin:24px 0 0 0;">
                ...
                <span style="color:#888;font-size:13px;">Sam-and-dot Â· Autonomous Developer Agent</span>
              </p>
            </td>
          </tr>
