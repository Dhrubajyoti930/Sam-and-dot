...
PHASE_IV_PROMPT = (
    ...
    "Format as a short markdown document with: ## Idea, ## Why, ## Implementation Steps, ## Risk, ## Detection Mechanism, ## Recovery Procedure.\n"
    "Be critical — question the idea yourself, identify one potential failure mode, propose a detection mechanism and a mitigation strategy, and assign a confidence score (1-10) to the implementation's success probability."
)
