...
PHASE_IV_PROMPT = (
    ...
    "Then, propose ONE concrete, implementable development idea for today. Before finalizing, conduct a 'Pre-Mortem' by listing one specific way this implementation could fail and how you would mitigate it. "
