...
DEFAULT_LOCATIONS = {
    "idea_of_day": "../My_memories/IDEA_OF_THE_DAY.md",
    "experiences": "../My_memories/experiences.json",
    "request": "../My_memories/request.json",
    "cycle_status": "../My_memories/cycle_status.txt",
    "prompt_patch": "../My_memories/prompt_patch.json",
    "worklog": "../My_memories/worklog.json",
    "sent_emails": "../My_memories/sent_emails.json",
}
