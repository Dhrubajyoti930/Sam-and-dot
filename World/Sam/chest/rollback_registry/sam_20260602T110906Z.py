...
def self_check() -> bool:
    """Rigorous integrity check â€” uses ruff to catch undefined names and logic errors."""
...
def apply_self_modification(plan: str) -> bool:
    ...
    if not operations:
        log.info("No patch operations extracted â€” skipping self-modification.")
        return False
...
def phase_v_development(idea: str, goals: dict) -> str:
    ...
    # âš ï¸  motion.md is read ONCE, here, and nowhere else.
